...
public class EcoCliente {
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      //socketCliente = new Socket("192.168.15.53", 4444);
    ...
    String linea;
    // El programa cliente no analiza los mensajes enviados por el usario, simplemente 
    // los reenvía al servidor hasta que este se despide con "Adios"
    try {
      while (true) {
